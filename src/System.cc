               ...
               mbDeactivateLocalizationMode(false)
{
    ...
    //Create Drawers. These are used by the Viewer，地图绘制函数，可视化地图点
    mpFrameDrawer = new FrameDrawer(mpMap);//固定了画布大小为640*480
    ...
    //Initialize the Viewer thread and launch，可视化工具
